                    ...
                    <div  class="slider-item" style={{backgroundImage:"url('assets/images/slideshow1-2.jpg')", backgroundPosition:"50%",backgroundRepeat:"no-repeat"}}>
                        ...
                        <div class="row">
                            ...
                            <div class="slider-caption">
                                ...
                                <h1 class="mt-2 mb-5 light-color"><span class="gray-color">Winter </span>Collection</h1>
            ...
            <div class="container">
                ...
                <div class="col-lg-3 col-sm-6 col-md-6">
                    ...
                    <div class="content">
                        ...
                        <p>Trên tất cả các đơn hàng trên 200k</p>
                    </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-md-6">
                ...
                <div class="col-lg-3 col-sm-6 col-md-6">
                    ...
                    <div class="content">
                        ...
                        <p>Thanh toán khi nhận hàng hoặc thanh toán bằng thẻ</p>
                    </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-md-6">
